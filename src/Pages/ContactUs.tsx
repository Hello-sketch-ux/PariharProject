  ...
  return (
    <div className="w-full min-h-screen bg-black px-4 sm:px-6 lg:px-8 py-10">
      <div className="text-center mb-12">
        ...
        <h2 className="text-2xl font-bold text-white">Better yet, see us in person!</h2>
          ...
          <div className="p-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <p className="text-sm font-medium text-white">Email ID</p>
                  <p className="text-sm text-gray-400">helpdesk@pariharindia.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-sm text-gray-400">7011989792</p>
                </div>
              </div>
            ...
            <form className="space-y-6">
              <div>
                ...
                <input
                  ...
                  name="name"
                  id="name"
                  className="text-white mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm"
      ...
      <div className="bg-gray-900 rounded-lg shadow-lg overflow-hidden mb-16">
        <div className="p-6">
      ...
      <div className="bg-gray-900 rounded-lg p-8 text-center">
        ...
        <p className="text-lg text-white mb-6">We are available to serve you 24/7</p>
