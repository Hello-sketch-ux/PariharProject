...
const Profile: React.FC<ProfileProps> = ({ userData }) => {
  ...
  return (
    <div className="w-full min-h-screen bg-black px-4 sm:px-6 lg:px-8 py-10">
      <div className="bg-gray-900 shadow overflow-hidden sm:rounded-lg">
        <div className="px-4 py-5 sm:px-6 flex justify-between items-center">
          <div>
            <h3 className="text-2xl leading-6 font-bold text-white">Profile Information</h3>
            <p className="mt-1 max-w-2xl text-sm text-gray-300">Personal details and preferences.</p>
          </div>
          {!isEditing ? (
            <button
        ...
        <div className="border-t border-gray-200">
          {isEditing ? (
            <form className="divide-y divide-gray-200">
              <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                ...
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                  <input
                    ...
                    className="max-w-lg block w-full shadow-sm focus:ring-green-500 focus:border-green-500 sm:max-w-xs sm:text-sm border-gray-300 rounded-md text-white"
                  />
                </div>
              </div>
              <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              ...
              <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <label htmlFor="dob" className="text-sm font-medium text-white">Date of birth</label>
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                  <input
                    type="date"
                    name="dob"
              ...
              <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                ...
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                  <textarea
                    ...
                    value={formData.bio}
                    onChange={handleChange}
                    className="max-w-lg shadow-sm block w-full focus:ring-green-500 focus:border-green-500 sm:text-sm border border-gray-300 rounded-md text-white"
                  ></textarea>
            ...
            <dl>
              <div className="bg-gray-900 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt className="text-sm font-medium text-gray-200 flex items-center">
                  <User className="mr-2 h-5 w-5 text-gray-200" />
                  Full name
                </dt>
              ...
              <div className="bg-gray-800 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt className="text-sm font-medium text-gray-200 flex items-center">
                  <Mail className="mr-2 h-5 w-5 text-gray-200" />
                  Email address
                </dt>
                <dd className="mt-1 text-sm text-gray-200 sm:mt-0 sm:col-span-2">
                  {userData.email}
              ...
              <div className="bg-gray-900 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt className="text-sm font-medium text-gray-200 flex items-center">
                  <Phone className="mr-2 h-5 w-5 text-gray-200" />
                  Mobile number
                </dt>
                <dd className="mt-1 text-sm text-gray-200 sm:mt-0 sm:col-span-2">
                  {formData.mobile}
              ...
              <div className="bg-gray-900 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt className="text-sm font-medium text-gray-200 flex items-center">
                  <Calendar className="mr-2 h-5 w-5 text-gray-200" />
                  Date of birth
                </dt>
                <dd className="mt-1 text-sm text-gray-200 sm:mt-0 sm:col-span-2">
              ...
              <div className="bg-gray-800 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt className="text-sm font-medium text-gray-200 flex items-center">
                  <Shield className="mr-2 h-5 w-5 text-gray-200" />
                  Account status
                </dt>
      ...
      <div className="mt-10 bg-gray-900 shadow overflow-hidden sm:rounded-lg">
        <div className="px-4 py-5 sm:px-6">
          <h3 className="text-lg leading-6 font-medium text-white">Account Security</h3>
          <p className="mt-1 max-w-2xl text-sm text-gray-300">Manage your account security settings.</p>
        </div>
        <div className="border-t border-gray-200 px-4 py-5 sm:p-0">
          <dl className="sm:divide-y sm:divide-gray-200">
            <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              <dt className="text-sm font-medium text-gray-300">Password</dt>
            ...
            <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              <dt className="text-sm font-medium text-gray-300">Two-factor authentication</dt>
              <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2 flex justify-between items-center">
            ...
            <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              <dt className="text-sm font-medium text-gray-300">Login devices</dt>
              <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2 flex justify-between items-center">
      ...
      <div className="mt-10 bg-gray-900 shadow overflow-hidden sm:rounded-lg">
        <div className="px-4 py-5 sm:px-6">
          <h3 className="text-lg leading-6 font-medium text-white">Preferences</h3>
          <p className="mt-1 max-w-2xl text-sm text-gray-300">Customize your experience.</p>
        </div>
        <div className="border-t border-gray-200 px-4 py-5 sm:p-0">
          <dl className="sm:divide-y sm:divide-gray-200">
            <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              <dt className="text-sm font-medium text-gray-300">Email notifications</dt>
            ...
            <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              <dt className="text-sm font-medium text-gray-300">SMS notifications</dt>
              <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                <div className="flex items-center">
                  <input
            ...
            <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              <dt className="text-sm font-medium text-gray-300">Language</dt>
              <dd className="mt-1 text-sm text-gray-300 sm:mt-0 sm:col-span-2">
                ...
                >
                  ...
                  <option className='text-black' value="punjabi">Punjabi</option>
                  <option className='text-black' value="gujarati">Gujarati</option>
                </select>
              </dd>
            </div>
          </dl>
