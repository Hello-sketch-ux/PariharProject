    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
      ...
      <div className="bg-white shadow overflow-hidden sm:rounded-lg mb-10">
        <div className="px-4 py-5 sm:px-6">
          <h3 className="text-lg font-medium text-gray-900">About Parihar India</h3>
        ...
        <div className="px-4 py-5 sm:p-6">
          ...
          <div className="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="bg-white shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                <div className="flex items-center mb-3">
                  <Package className="h-7 w-7 text-green-500 mr-3" />
            ...
            <div className="bg-white shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                <div className="flex items-center mb-3">
                  <Truck className="h-7 w-7 text-blue-500 mr-3" />
                  <h4 className="text-base sm:text-lg font-medium text-gray-900">
                    Fast Delivery
                  </h4>
                </div>
