...
const Dashboard: React.FC<DashboardProps> = ({ userData }) => {
  ...
  // ✅ Fetch user count with retry (handles Render sleep)
  const fetchUserCount = async () => {
    try {
      const res = await fetch("https://pariharback.onrender.com/api/users/count");
      ...
      console.log("Retrying user count fetch...");
      setTimeout(fetchUserCount, 3000); // retry after 3 sec
    }
  };
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="mb-8">
        ...
        <p className="mt-2 text-lg text-gray-600">
          Your trusted partner for safety and hygiene.
        </p>
      </div>
        ...
        <div className="border-t border-gray-200">
          ...
          <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            ...
            <div className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
              We offer innovative, high-quality hygiene solutions that ensure safety,
              comfort, and protection in public restrooms.
            </div>
          </div>
